...
{
    internal class RidingTour : ITour
    {
        public void Tour()
        {
            Console.WriteLine("The riding tour, wonderful. You will get a expirence that is quicker, but you will get to take in more of what we offer and in comfort.");
        }
